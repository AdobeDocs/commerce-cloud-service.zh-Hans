...
所有参与到该项目的第三方稿件都必须附有签署的参与者许可协议。 这将允许Adobe在项目中再次分发您贡献的内容。 [签署我们的CLA](https://opensource.adobe.com/cla.html). 您只需提交一次AdobeCLA即可，因此，如果您以前已经提交过，则无需重新提交！

## 代码审阅

所有提交都应采用拉取请求的形式，并且需要由项目提交者进行审核。 读取 [GitHub的拉取请求文档](https://docs.github.com/articles/about-pull-requests/)
以了解有关发送拉取请求的更多信息。
